...
import ingredientCategory from 'routes/ingredientCategory';
import ingredientCategories from 'routes/ingredientCategories';
...
export const start = async () => {
  ...
  app.use('/ingredient/category', ingredientCategory);
  app.use('/ingredient/categories', ingredientCategories);
